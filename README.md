...
Next.js glass UI. Tabs: **Home** (`/`) | **Player** (`/player`) | **Insight** (`/insight`).
...
## Phase 3 locks
- Chart: raw curated per-game; max 5 seasons; default scope reg_only; skip min≤0 for values
...
- Radar: Recharts RadarChart; 9 corners PTS AST 3PM REB STL BLK FG% FT% TOV; ≤5 season polygons
